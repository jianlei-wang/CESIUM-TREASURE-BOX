...
export const demos: CaseMeta[] = [
  ...
  { id: "fireworks-three", title: "Three.Quarks 烟花粒子", category: "three", description: "基于 three.quarks 粒子引擎与 Cesium 地球的烟花特效：球壳发射器定时爆裂，多层辉光球壳与拉伸拖尾火星同步绽放，重力与随机位置让烟花在地球上空连续随机升起，可选缤纷、金色、赤红、湛蓝、紫罗兰五种配色，所有参数可实时调整并重建粒子系统", tag: "Three.js, three.quarks, 粒子特效", updatedAt: "2026-09-19", available: true },
  ...
  { id: "flame-three", title: "Three.Quarks 火焰粒子", category: "three", description: "基于 three.quarks 粒子引擎与 Cesium 地球的火焰特效：锥形发射器配合浮力力场与湍流场，明火主体由亮黄到暗红渐变收缩，叠加高速飞溅火星，所有参数（发射速率、寿命、浮力、张角、湍流强度等）可实时调整并重建粒子系统", tag: "Three.js, three.quarks, 粒子特效", updatedAt: "2026-09-19", available: true },
  ...
  { id: "fountain-three", title: "Three.Quarks 喷泉粒子", category: "three", description: "基于 three.quarks 粒子引擎与 Cesium 地球的喷泉特效：锥形发射器喷出高速水滴，重力作用形成抛物线回落，叠加水雾粒子与湍流扰动，所有参数（发射速率、寿命、速度、张角、重力、水雾浓度等）可实时调整并重建粒子系统", tag: "Three.js, three.quarks, 粒子特效", updatedAt: "2026-09-19", available: true },
  ...
  { id: "smoke-three", title: "Three.Quarks 烟雾粒子", category: "three", description: "基于 three.quarks 粒子引擎与 Cesium 地球的烟雾特效：程序化烟雾纹理配合上升力、风力与三维湍流场，粒子随生命周期逐渐放大、自旋、变淡并漂移扩散，所有参数（发射速率、寿命、上升力、风力、湍流、自旋、不透明度等）可实时调整并重建粒子系统", tag: "Three.js, three.quarks, 粒子特效", updatedAt: "2026-09-19", available: true },
