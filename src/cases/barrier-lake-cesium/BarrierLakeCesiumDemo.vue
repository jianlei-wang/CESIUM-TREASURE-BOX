...
import { BarrierLakeCesiumScene, STEP_COUNT, STEP_META } from './BarrierLakeCesiumScene'
...
let scene: BarrierLakeCesiumScene | null = null
...
onMounted(() => {
  ...
  scene = new BarrierLakeCesiumScene(canvasHost.value, { onStepChange }, flashEl.value)
})
  ...
  <div class="fy-shell">
    ...
    <div class="control-panel">
      <div class="panel-title-row">
        <span class="panel-title">堰塞湖形成与溃决</span>
