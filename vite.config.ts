...
const CESIUM_SYMBOLS = [
  ...
  'EllipsoidTerrainProvider', 'Entity', 'Event', 'DeveloperError', 'FrameRateMonitor', 'Framebuffer', 'GeoJsonDataSource',
  ...
  'PolylineGeometry', 'PolylineGlowMaterialProperty', 'PolylineGraphics',
  ...
  'PropertyBag', 'Quaternion', 'Ray',   'Rectangle', 'RectangleGeometry', 'RenderState', 'Renderbuffer', 'RenderbufferFormat', 'Resource', 'SampledPositionProperty',
