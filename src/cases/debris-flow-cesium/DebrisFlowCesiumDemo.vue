...
import { DebrisFlowCesiumScene, STAGES } from './DebrisFlowCesiumScene'
...
let scene: DebrisFlowCesiumScene | null = null
...
const stageTxt = [
  '暴雨在上游形成区汇集，坡面产流汇入沟道，清水冲刷沟床并把松散碎屑带走。',
  '水流冲刷加剧，沟床与岸坡的松散固体物质大量加入，水体由清转浑、容重迅速增大。',
  '泥浆裹挟石块呈阵性下泄，龙头在前端翻滚推进，沿途不断裹入物质并冲刷边岸。',
  '泥石流出沟后地形骤缓、水分下渗，石块泥沙就地停积形成堆积扇并威胁沟口村庄。'
]
...
onMounted(() => {
  ...
  scene = new DebrisFlowCesiumScene(canvasHost.value, { onProgress })
})
  ...
  <div class="fy-shell">
    ...
    <div class="control-panel">
      <div class="panel-title-row">
        <span class="panel-title">泥石流形成与运动演示</span>
