...
const colorHex = ref('#ff3355')
const opacity = ref(0.8)
const speed = ref(3)
const lineWidth = ref(8)

const LINE_ID = 'line-flicker'
...
function place(lon: number, lat: number): void {
  ...
  resultMessage.value = `闪烁线已平移至 ${lon.toFixed(4)}, ${lat.toFixed(4)}`
}
...
<template>
  <div class="line-flicker-shell">
    <div ref="container" class="cesium-container"></div>

    <div class="control-panel">
      <div class="panel-title">闪烁线效果</div>
      ...
      <div class="control-row">
        <span class="row-label">闪烁频率</span>
      ...
      <p class="hint">整条线按频率明暗闪烁，适合告警/重点线路标识；开启放置后单击地图可整体平移折线。</p>
...
<style scoped>
.line-flicker-shell { position: relative; width: 100%; height: 100%; min-height: 320px; overflow: hidden; border-radius: 8px; background: #152b4c; }
